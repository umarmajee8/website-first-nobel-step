        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs font-bold text-gray-700 dark:text-gray-200">
              ...
              <li><a href="/privacy-policy.html" className="hover:text-green-600 dark:hover:text-green-400 transition-colors cursor-pointer">Privacy Policy</a></li>
              <li><a href="/terms-and-conditions.html" className="hover:text-green-600 dark:hover:text-green-400 transition-colors">Terms & Conditions</a></li>
            </ul>
          </div>
